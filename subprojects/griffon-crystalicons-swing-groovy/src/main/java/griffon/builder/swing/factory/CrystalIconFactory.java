...
public class CrystalIconFactory extends AbstractFactory {
    ...
    public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
        ...
        } else if (icon instanceof Crystal) {
            return new CrystalIcon((Crystal) icon, size);
        }

        throw new IllegalArgumentException(name + " cannot parse " + icon + " as a CrystalIcon description.");
    }
}
